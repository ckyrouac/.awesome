...
switcher.settings.preview_box_fps = 120                              -- refresh framerate
...
globalkeys = awful.util.table.join(
    ...
    -- Print screen
    awful.key({ }, "Print", function () awful.util.spawn("escrotum -s /home/chris/screenshots/%Y-%m-%d_%H%M%S_screenshot.png") end),
